							...
							.controller(
									...
									var oFilter = new sap.ui.model.Filter("FleetName",sap.ui.model.FilterOperator.Contains,sValue);
										...
										onFleetCloseButton:function(){
											...
											that.getView().byId("fltName").setText(that.fleetName)
											that.showChart();
...
//																	.navTo("page2");
													...
													title : {
														display : true,
														text : 'Digital analysis for Hubs'
													},
												}
											});
									this.bindTable();

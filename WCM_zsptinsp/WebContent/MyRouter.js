...
jQuery.sap.declare("com.acute.spinsp.MyRouter");

sap.ui.core.routing.Router.extend("com.acute.spinsp.MyRouter", {
...
//		var temp = oControl.sViewName.split("view.");
//		if (temp[1] == "Launchpad")
//		{ sAncestorControlName = "masterView"; }
//		else

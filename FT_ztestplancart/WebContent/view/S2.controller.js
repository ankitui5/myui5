...
jQuery.sap.require("com.acute.ztestplancart.util.formatte");
var that;

sap.ui.controller("com.acute.ztestplancart.view.S2", {
	...
	onInit: function() {
		...
		jQuery.sap.includeStyleSheet(jQuery.sap.getModulePath("com.acute.ztestplancart.css.style", ".css"));

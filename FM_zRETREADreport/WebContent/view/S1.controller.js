...
jQuery.sap.require("zretreadreport.util.Formatter");
...
sap.ui.core.mvc.Controller.extend("zretreadreport.view.S1",{
	...
	this.GRNDialog = new sap.m.SelectDialog({
				...
				items : {
					...
					template : new sap.m.StandardListItem({
						title : "{Mblnr}",
						description:"{path:'Erdat',formatter:'zretreadreport.util.Formatter.date1'}",

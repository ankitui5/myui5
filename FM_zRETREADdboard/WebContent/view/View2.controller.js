...
"use strict";
var that,Dealer,DealerName,Material, Customer ,Stencil ,Status,StnclNumber,DealerKunnr,Kunnr,GRN,CustomerType,Status,Mblnr;
return sap.ui.controller("zretreaddboard.view.View2", {
...
//////////////////////Material f4////////////////////////////////
				onF4GRN:function(){
					debugger
					var sPath = "/sap/opu/odata/sap/ZFLEET_SRV/F4GetGrnSet?$filter=Dealer eq '"+Dealer+"' and App eq 'A'and HubCode eq ''";
					var customerModel = new sap.ui.model.json.JSONModel();
						customerModel.loadData(sPath, null, false,"GET",false, false, null);
					...
					var _customerDialog = new sap.m.SelectDialog({
						...
						//	var that = this;
							...
							confirm : [ this._handleGRNClose, this ],
							cancel :  [ this._handleGRNClose, this ]
					});
						_customerDialog.setModel(customerModel);
					...
					_handleGRNClose: function(oEvent) {
							...
							this.getView().byId("IdGRN").setValue(Mblnr);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
			onStencilHelp:function(){
				...
				var uid = user.getId()
				var sPath = "/sap/opu/odata/sap/ZFLEET_SRV/F4CasingStencilSet?$filter=Dealer eq '"+Dealer+"' and App eq 'A' and HubCode eq ''";
				var jModel = new sap.ui.model.json.JSONModel();
				jModel.loadData(sPath, null, false,"GET",false, false, null);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////							
			...
			if(this.dateFrom){
			var path = "CasingReportSet?$filter=Mblnr eq '"+GRN+"' and Customer eq '"+Customer+"' and Status eq '"+Status+"' and StnclNumber eq '"+Stencil+"' and Dealer eq '"+Dealer+"' and DateFrom  eq datetime'"+this.dateFrom+"' and DateTo  eq datetime'"+this.dateTo+"' and CType eq '"+CustomerType+"'";
			}else{
			var path = "CasingReportSet?$?$filter=Mblnr eq '"+GRN+"' and Dealer eq '"+Dealer+"' and Customer eq '"+Customer+"' and StnclNumber eq '"+Stencil+"' and Status eq '"+Status+"' and DateFrom eq "+null+'  and DateTo eq '+null+" and CType eq '"+CustomerType+"'";
			}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
				onClear : function(oEvent){
					...
					this.getView().byId("IdStencil").setValue("");
		...
		onDownload : sap.m.Table.prototype.exportData || function(oEvent) {
			...
			columns: [
							...
							},
						{
							name: "Customer Type",
							template: {
							content: "{path:'CType',formatter:'zretreaddboard.util.Formatter.customerType'}"
							},
							},
						{
							...
							},
						{
							name: "Repair Status",
							template: {
							content: "{path:'JobStatus',formatter:'zretreaddboard.util.Formatter.repairStatusText'}"
							},
							},
						{
							name: "Repaired Date",
							...
							},
						{
							name: "Status",
							template: {
							content: "{path:'Status',formatter:'zretreaddboard.util.Formatter.statusText'}"
							},
							},
					]
				});

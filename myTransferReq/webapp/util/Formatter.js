sap.ui.define([
	...
	var Formatter = Element.extend("com.cpwdmyTransferReq.util.Formatter");
	...
	Formatter.checkIsDirectManager = function (value){
		if (value=="X"){
			return true;
		}else{
			return false;
	...
	Formatter.returnCurrentStatus = function(value){
         if(value == "X"){
	...
	Formatter.formatMgrCommentDt = function (value) {
		if (value) {
